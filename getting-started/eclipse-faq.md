...
No, Eclipse uses ETH for gas, you will need to bridge some ETH from Ethereum Mainnet in order to transact on Eclipse, you can use this [guide](/getting-started/eclipse-bridging-eth) to learn how to use the [Eclipse Canonical Bridge](https://bridge.eclipse.xyz/).

#### How do I switch to Eclipse on Orca?

The Orca UI incorporates a simple switching mechanism, the Network Selection Menu, a simple guide can be found [here](/getting-started/eclipse-connecting)
