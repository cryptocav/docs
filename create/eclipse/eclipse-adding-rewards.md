---
title: How to add rewards to a pool on Eclipse
description: Incentivize liquidity providers by adding token rewards to your Eclipse pool.
icon: coins
---
...
* See [here](/create/eclipse/eclipse-orca-token-list) to request your token is added to the *Orca Token List.* **Ensure you provide contact details**.
