...
* (Optional) Adjust your liquidity slippage by clicking on the liquidity button - see [Understanding Slippage](/reference/educational-documents/understanding-slippage) for more details. Once you are satisfied with your deposit values, click Deposit.
