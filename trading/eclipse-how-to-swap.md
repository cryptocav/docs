---
title: How to trade with Orca on Eclipse
description: Step-by-step guide to swapping tokens on Eclipse.
...
* **Trade on Orca**
   ...
   * (Optional) If you want to adjust slippage manually you can do by clicking on the cog symbol at the top right (see [Understanding Slippage](/reference/educational-documents/understanding-slippage))
