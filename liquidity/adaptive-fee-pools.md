...
* [Ticks and tick spacing](/reference/educational-documents/understanding-ticks-tick-spacing-and-fee-tiers-on-orca) still define where your liquidity lives.
* [Fee tiers](/reference/educational-documents/understanding-ticks-tick-spacing-and-fee-tiers-on-orca) still serve as the base fee, and LPs choose them when depositing.

* You still earn [fees](/reference/useful-information/trading-fees) when trades occur within your active tick range.
