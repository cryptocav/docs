...
In addition to closing a position using the [*withdraw liquidity*](/liquidity/manage/withdraw) function, a position can be closed directly using the *Close Position* function
...
* Select `× Close Position`.
   ...
   ![](/images/image_76.jpg)
* Check the displayed details, then click `Close Position`.

   ![](/images/image_77.jpg)
* Review details in your wallet and confirm.
