...
description: Collect your earned trading fees and rewards from Eclipse positions.
icon: droplet
---
...
You can also harvest yield from a single position using the [Portfolio Management Sidebar](/liquidity/eclipse/eclipse-portfolio-sidebar).
