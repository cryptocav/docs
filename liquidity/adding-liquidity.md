...
Due to [divergence loss](/reference/educational-documents/impermanent-loss), you are not guaranteed a positive return when providing liquidity.

#### Open the Position Details sidebar

→ See the [Position Details Sidebar Guide](/liquidity/position-sidebar) for a full walkthrough.
...
→ See [**Understanding Slippage**](/reference/educational-documents/understanding-slippage) for more information.
...
You've now added liquidity to your position on Orca! Check your position anytime on the [Portfolio page](https://www.orca.so/portfolio) and see our [Managing Your Portfolio](/liquidity/managing-portfolio) guide for help with further management of your position.
