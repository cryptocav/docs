---
title: "Overview of Orca's SDKs"
description: "Orca provides a range of SDKs that cater to different levels of development needs for interacting with the Whirlpool Program on Solana and Eclipse. Whether you are managing liquidity, building applica..."
---

# Overview of Orca's SDKs

![Overview of Orca Whirlpools SDK suite](/images/developers/orca-sdks-overview-ecedf0f3d1baa8fdf5ff2f1887f8ae41.png)
...
* **Rust**: [orca\_whirlpools](https://crates.io/crates/orca_whirlpools)
...
* **Rust**: [orca\_whirlpools\_core](https://crates.io/crates/orca_whirlpools_core)
...
* **Rust**: [orca\_whirlpools\_client](https://crates.io/crates/orca_whirlpools_client)
