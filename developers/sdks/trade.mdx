---
title: "Executing a Token Swap"
description: "You can use the SDK to execute a token swap on Orca. Whether you're swapping a specific amount of input tokens or looking to receive a precise amount of output tokens, this function handles the prepar..."
---
...
For more details, refer to our [Environment Setup Guide](/developers/sdks/environment-setup)
...
* [Open a Position](/developers/sdks/positions/open-position): Provide liquidity to the pool and earn fees.
* [Monitor Positions](/developers/sdks/positions/monitor-positions): Track your position's performance over time.
...
Before we begin, you should have an understanding of what ticks are and how they are stored. If not, you can reference [Price & Ticks](/developers/architecture/price-and-ticks).
...
To learn more about tick-arrays and how its traversal works, read [Understanding Tick Arrays](/developers/architecture/tick-arrays).
...
2. Trading a max amount of 50 token B for 100 token A
   ...
   ```
3. Trade whatever amount needed to move the price from current sqrt-price 50\_x64 to sqrt\_price 250\_x64
