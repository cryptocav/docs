---
title: "Sending and Landing Transactions"
description: "* Rust & Typescript Kit"
---
...
* At the time of writing, 85% of Solana validators are Jito validators. Jito validators happily accept an additional tip, in the form a SOL transfer, to prioritize a transaction. A good place to get familiarized with Jito is here: [https://www.jito.network/blog/jito-solana-is-now-open-source/](https://www.jito.network/blog/jito-solana-is-now-open-source/)
...
<Card title="🔗 Whirlpools Instruction Set" icon="github" href="https://dev.orca.so/legacy/classes/WhirlpoolIx.html">
