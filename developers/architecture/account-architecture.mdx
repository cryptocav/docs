...
description: "Understand the account structure of Orca Whirlpools including WhirlpoolsConfig, FeeTier, Position, and TickArray accounts."
---
...
![Account Architecture](/images/developers/architecture-overview-1671762e13baf6ad6afe1ed83dd0412b.png)

## WhirlpoolsConfig

The owner of a Config account has the authority to define the many authorities over the pools that it owns (ex. default fees, collect protocol fees etc.). Whirlpools visible on the ORCA UI are all derived and controlled by a WhirlpoolsConfig account owned by the ORCA foundation. To learn more about managing pools, start [here](/developers/sdks/pools/create-pool).
...
![Whirlpool Overview](/images/developers/whirlpool-overview-015cad00b617958fdd7aec9d7a608346.png)
...
To learn about TickArray, read [Understanding Tick Arrays](/developers/architecture/tick-arrays)

## Position

Positions represent a set of liquidity distributed on a price range within a single Whirlpool. To learn more, read [Tokenized Positions](/developers/architecture/tokenized-positions)
