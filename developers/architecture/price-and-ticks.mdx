---
title: "Price & Ticks"
description: "Understanding how Whirlpool tracks prices using square-root price and ticks"
---
...
Given the supported price-range of `[2^-64, 2^64]`, the tick range for a Whirlpool is `[-443636, 443636]`.
