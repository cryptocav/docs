...
The ORCA governance token was launched on 9th August 2021. See the [Token Treasury](/governance/treasury) page for more details. For details of Orca's governance process please see the [Governance User Guide](https://docs.orca.so/orca-for-holders/governance/tutorials/governance-v0-user-guide).
...
Yes, on Orca v2 it is possible to harvest a single position through Orca's UI, you can find instructions [here](/liquidity/manage/harvest).
...
Token Extensions are advanced functionalities for tokens to comply with legal requirements. Majority of the tokens created do not need Token Extension functionalities turned on. For more information, check out our [Token Extensions document](/create/pools/extensions).
